...
export default function CustomerQuizStep4() {
  return (
    <div className="container mx-auto px-4 py-8">
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          <CardTitle>Find Your Therapist - Step 4</CardTitle>
          ...
          <form className="space-y-4">
            ...
            <div className="flex justify-between">
              <Button variant="outline" asChild>
                <Link href="/quiz/customer/step3">Back</Link>
              </Button>
              <Button asChild>
                <Link href="/quiz/customer/step5">Next</Link>
              </Button>
            </div>
          </form>
        </CardContent>
